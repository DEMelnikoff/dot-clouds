...
const dots = function(c, signal, noise, trialType, responseKeys, nDots) {
    ...
    const id = setInterval(() => {
        ...
        let randIdx = jsPsych.randomization.repeat(idx, 1);
        if (trialType == 'zigZag') {
            n1 = nDots - (signal*zigVec[zig]);
            n2 = nDots + (signal*zigVec[zig]);
